...
{{-- 
          ...
          {{-- <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('admin.passwordchange') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Password change</p>
                </a>
              </li>
